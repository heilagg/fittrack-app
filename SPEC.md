...
| `POST /v1/workouts/{id}/exercises/{we_id}/sets` | Логирует подход, отдаёт следующий и новое дерево §20.9 | `{id, set_index, actual_kg?, actual_reps?, feedback?, pain_flag, rest_seconds?, skipped, completed_at, date, tz}` |
