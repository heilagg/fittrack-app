...
halfLife: крупные мышцы (glute_max, quads, hamstrings, lats, pecs) — 30 ч
          мелкие (biceps, triceps, side_delts, calves) — 20 ч
...
2. Объём на переутомлённую мышцу −30%.
...
2. Предлагается 3 альтернативы с похожим профилем вклада мышц, но другим
   `joint_stress`.
3. Упражнение исключается из подбора на 14 дней.
