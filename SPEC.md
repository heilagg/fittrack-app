...
**Предел — 512 узлов**, и обоснован он не замером, а потолком, который уже стоит
в §7.3: подходов на упражнение не больше пяти, значит переходов не больше
четырёх, а 6⁴ = 1296 достигается только если не сойдётся ни одна ветка — чего
округление к лестнице не допускает. То есть предел в MVP не срабатывает ни при
каком инвентаре и служит предохранителем. Если он всё же превышен, дерево
