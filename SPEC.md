...
- **Вес — куб доли мышцы относительно наибольшей в векторе.** Без веса w11 = 3
  ...
  квадрате и −0.7 при кубе. В однородной неделе «низ с акцентом» недельный `glute_max` при кубе тот
  же, что без w11, при любом бюджете: 16.0 при 60, 45 и 30 минутах, 10.1 при 20.
...
`glute_max` и 8.0 на квадрицепс. Это не недосмотр: доли вектора отличаются в 6–7 раз, границы
