...
//   - готовность для веса упражнения: надбавка выше 1.0 срезается, если хоть
//     одна нагруженная мышца получила от утомления надбавку RIR (§8.2,
//     fatigue > 1.8). Вес следует порогу RIR, подходы — порогу объёма. Planner
//     передаёт результат в Progression как готовность этого упражнения.
