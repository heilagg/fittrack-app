...
//   - логировать в FitCore нечем: логгера у пакета нет, как нет и Foundation
//     с его Date, и это зафиксированное правило (см. Package.swift). Ровно
//     ноль import'ов в пакете было до Recovery: `FatigueDecay.swift` берёт
//     `pow` из Darwin/Glibc (SPEC §8.1), но канала для логов это не даёт;
