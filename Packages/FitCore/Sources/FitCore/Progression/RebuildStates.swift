...
extension Progression {
    ...
    ///   здесь не действует, и это не пробел: правило живёт в `nextSet`, у
    ///   которой счётчик — параметр, а свёртка идёт МЕЖДУ сессиями и лимита
    ///   внутри одной не видит по построению;
