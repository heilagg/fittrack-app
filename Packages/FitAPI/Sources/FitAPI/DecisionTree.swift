...
/// ровно для различимых состояний: на четырёх переходах их 17–54 на реальных
/// лестницах (замер `test_mapSizeIsTensOfNodesNotThousands`: штанга 17 и 42,
/// стек 40 и 53, гантели 40 и 54 — без калибровки и в ней). При вложенном кодировании то же самое разворачивается в 1483
